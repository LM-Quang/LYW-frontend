...
import { KEYWORD_PARAMS, TOPIC_PARAMS } from "@/utils/constant";
...
export default function CoursesPage() {
   ...
   const topic = searchParams.get(TOPIC_PARAMS) || "";
   ...
   // }, [selectedCategories, selectedLevels, priceFilter, minRating]);
