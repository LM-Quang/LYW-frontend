   ...
   return (
      <section className="mb-12 container mx-auto relative z-10 overflow-visible">
         ...
         <div>
            <button
               ref={prevRef}
               className={`absolute left-[-10px] top-1/2 border border-gray-200 shadow-md bg-white rounded-full p-2.5 transform -translate-y-1/2 z-30 cursor-pointer hover:bg-gray-100 transition-opacity duration-200 
                     ${isBeginning ? "hidden" : ""}
                     `}
            ...
            <button
               ref={nextRef}
               className={`absolute right-[-10px] top-1/2 border border-gray-200 shadow-md bg-white rounded-full p-2.5 transform -translate-y-1/2 z-30 cursor-pointer hover:bg-gray-100 transition-opacity duration-200 
                  ${isEnd ? "hidden" : ""}`}
